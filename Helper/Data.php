...
class Data extends AbstractHelper
{
    ...
    public function isMobile()
    {
        ...
        return preg_match(
            ...
            'ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|' .
            ...
            'dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|' .
            'fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|' .
    ...
    public function areEqualAmounts($amount1, $amount2)
    {
        if ($amount2 == 0) {
            ...
            return abs(((float) $amount1 - (float) $amount2) / (float) $amount2) <= 0.01;
        }
    }
