...
class BuckarooAdapter extends Adapter
{
    ...
    /** Key of the capture (Pay) transaction – the refund target for Klarna methods (BTI-1267) */
    ...
    /** Key of the Klarna MOR Reserve DataRequest – never a valid refund target (BTI-1267) */
