...
define(
    ...
    function (
        ...
        function checkPayments(){
            var p = ["billink","klarnakp","capayableinstallments","sofortbanking","giropay","transfer","sepadirectdebit","capayablein3","creditcards","creditcard","mrcash","payperemail","emandate","rtp", "tinka"];
