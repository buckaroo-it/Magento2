...
define(
    ...
    function (
        ...
        return Component.extend(
            {
                defaults: {
                    template: 'Buckaroo_Magento2/payment/buckaroo_magento2_ideal2'
                },
                banktypes: [],
             ...
             */
                ...
                initObservable: function () {
                    ...
                    this.banktypes = ko.observableArray(window.checkoutConfig.payment.buckaroo.ideal2.banks);

                    this.selectionType  = window.checkoutConfig.payment.buckaroo.ideal2.selectionType;
             ...
             */
                ...
                payWithBaseCurrency: function () {
                    var allowedCurrencies = window.checkoutConfig.payment.buckaroo.ideal2.allowedCurrencies;
