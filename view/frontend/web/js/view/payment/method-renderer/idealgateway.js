...
define(
    ...
    function (
        ...
        return Component.extend(
            {
                defaults: {
                    template: 'Buckaroo_Magento2/payment/buckaroo_magento2_idealgateway'
                },
                banktypes: [],
                ...
                selectionType: null,
                paymentFeeLabel : window.checkoutConfig.payment.buckaroo.idealgateway.paymentFeeLabel,
             ...
             */
                ...
                initObservable: function () {
                    ...
                    this.banktypes = ko.observableArray(window.checkoutConfig.payment.buckaroo.idealgateway.banks);

                    this.selectionType  = window.checkoutConfig.payment.buckaroo.idealgateway.selectionType;
             ...
             */
                ...
                payWithBaseCurrency: function () {
                    var allowedCurrencies = window.checkoutConfig.payment.buckaroo.idealgateway.allowedCurrencies;
