    ...
    function (
        ...
        return Component.extend({
            ...
            showPayButton: function () {
                ...
                if (gpConfig && gpConfig.availableButtons &&
                    gpConfig.availableButtons.indexOf('Product') !== -1 &&
                    gpConfig.integrationMode === '0'
                ) {
                    googlepayPay.setQuote(quote);
                    googlepayPay.showPayButton('product');
                }
            }
        });
    }
