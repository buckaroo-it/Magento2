...
abstract class AbstractTransactionBuilder implements BuilderInterface
{
    /**
    ...
    public function build(array $buildSubject)
    {
        ...
        $transaction = $this->transaction->setBody($this->getBody($buildSubject));
     ...
     * @return array
     */
    abstract public function getBody(array $buildSubject);
