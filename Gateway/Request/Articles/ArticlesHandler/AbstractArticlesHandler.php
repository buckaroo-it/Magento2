...
abstract class AbstractArticlesHandler implements ArticleHandlerInterface
{
     ...
     *
     * Captures and refunds run in the admin/CLI context, so `__()` would translate against the
     * current store: the reserve sends "Versandkosten" while the capture sends "Shipping fee" for
     * the same order. Emulating the order's store keeps the article lines identical (BTI-1267).
     *
